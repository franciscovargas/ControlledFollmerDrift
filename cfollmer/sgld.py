#  taken from https://github.com/MFreidank/pysgmcmc/blob/pytorch-sghmchd/pysgmcmc/
import torch
from torch.optim import Optimizer
from cfollmer.sg_sampler_utils import SamplerMixin
